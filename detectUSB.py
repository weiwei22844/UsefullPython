...
class Window(QWidget):
    ...
    def onDeviceChanged(self, wParam, lParam):
        ...
        if (DBT_DEVICEARRIVAL == wParam or DBT_DEVICEREMOVECOMPLETE == wParam):
            ...
            elif dbh.dbch_devicetype == DBT_DEVTYP_PORT:
                dbp = DEV_BROADCAST_PORT.from_address(lParam)
                self.logEdit.appendPlainText(dbp.dbcp_name)
